...
if((e107::wysiwyg(null, true) === 'tinymce5' && check_class($pref['post_html'])) || strpos(e_SELF,"tinymce5/admin_config.php") )
{
	if(e_PAGE != 'image.php')
	{
	...
	//	e107::js('footer', "//cdn.tinymce.com/4/tinymce.min.js");
		...
		$mceScript = e_PLUGIN.'tinymce5/wysiwyg.php';
...
//	else
	{
	//	e107::js('tinymce5','plugins/compat3x/tiny_mce_popup.js');
...
//	print_a($_POST);
	...
	$(function() {
			...
			//	alert(s);
				...
				var p = $.ajax({
					type: 'POST',
					url: '".e_PLUGIN_ABS. "tinymce5/plugins/e107/parser.php', // parse bbcode value
